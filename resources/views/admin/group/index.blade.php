...
<div class="row">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <a class="btn btn-default " href="{{url('admin/group/create')}}" role="button">
                      <i class="fa fa-plus"></i> เพิ่มกลุ่ม</a>
                  </div>
                ...
                @foreach($objs as $u)
                    <tr {{$i++}}>
                      ...
                      <td>
                        ...
                        href="{{url('admin/group/'.$u->id.'/edit')}}" role="button"><i class="fa fa-wrench"></i> </a>

                          <form  action="{{url('admin/group/'.$u->id)}}" method="post" onsubmit="return(confirm('Do you want Delete'))">
